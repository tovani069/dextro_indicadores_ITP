...
const fmtHd = (v: number) => v.toLocaleString("pt-BR", { maximumFractionDigits: 1 }) + "h";
 ...
 * detalhe. Mostra também os dias úteis sem lançamento — é neles que mora o
 * buraco do "% Preenchimento".
 */
      ...
      <div className={"modal-card" + (visivel ? " anim-cartao" : "")} style={{ width: "min(96vw,780px)" }}>
        ...
        >
          {[
            ...
            { rotulo: "Sem lançamento", valor: String(resumo.vazios), cor: resumo.vazios ? "#FF5C6A" : "var(--text3)" },
            ...
            >
              ...
              <div className="mono" style={{ fontSize: 16, fontWeight: 600, color: k.cor }}>
                {k.valor}
              </div>
            </div>
          ))}
        ...
        <div style={{ padding: "14px 22px 22px" }}>
          ...
          <div style={{ fontSize: 10, color: "var(--text3)", marginTop: 8 }}>
            Jornada de referência: {JORNADA_PADRAO}h por dia útil. Fins de semana e feriados só
            aparecem quando houve lançamento.
          </div>
        </div>
      </div>
    </div>
